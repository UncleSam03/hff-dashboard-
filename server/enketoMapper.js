...
export function enketoToHffRow(xml, nextId = "") {
    try {
        ...
        /**
         * Robustly find a value by tag name, ignoring namespaces and depth.
         */
        const getValue = (tagName) => {
            ...
            // Fallback for tags with namespaces (e.g. <d:first_name>)
        ...
        // Determine if this is a check-in for a specific day
        ...
        // Expanded gender search (case-insensitive variants)
        ...
        console.log(`[Mapper] Parsed: ${firstName} ${lastName} (Day: ${dayStr || 'Registration'}, Gender: ${genderValue || 'Unknown'})`);

        // Mapping based on hffRegister.js expectations (index-based)
        return [
            nextId,                 // 0: No.
